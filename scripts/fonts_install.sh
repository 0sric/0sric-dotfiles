...
echo "Installing NotoMono Nerd Font Mono..."
wget -O /tmp/notomono.zip https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/Noto.zip
unzip -j /tmp/notomono.zip -d ~/.local/share/fonts/
rm /tmp/notomono.zip
